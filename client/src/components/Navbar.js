...
export default function Navbar() {
  return (
    <ul className="flex items-center justify-between px-2 h-16 shadow-md">
      <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-recycle" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#60d394" fill="none" strokeLinecap="round" strokeLinejoin="round">
